            ...
            <div className="posts-section">
                <div className="post-bar">
                    ...
                    <div className="epi-sec">
                        <ul className="descp">
                            <li><img src="/images/icon9.png" alt=""/><span>{this.props.obj.user.workspace.name} {t('workspace')} </span></li>
                        </ul>
                    </div>
                    <div className="job_descp">
                        <h3>{this.props.obj.title}</h3>
                        <p> {html}<Link to={'/detail-posts/' + this.props.obj.id} > {t('read-more')} </Link></p>
                    </div>
                    <div className="job-status-bar">
                        <ul className="like-com">
                            <li onClick={this.PopupVote}> 
                                <a className="com"> <i className="fa fa-group"></i>{t('user-vote')} {this.props.obj.vote_count}</a>
                            </li>
                            <li onClick={this.togglePopup}><a href="#" title="" className="com"><img src="images/com.png" alt=""/> {t('comment')} {this.props.obj.comments_count}</a></li>
                        </ul>
...
export default translate('translations')(ItemPost);
